...
<Alert variant="warning" title="Heads up!">
  ...
  This tutorial is quite outdated and should not be the reference anymore. By
  now there are libs which solve the issue directly like{" "}
  <a class="a" href="https://www.npmjs.com/package/@josempgon/vue-keycloak">
    vue-keycloak
  </a>
</Alert>
